...
pub fn mark_revenue_tax_failed(db: &Database, opportunity_id: &str, reason: &str) -> Result<bool> {
    update_revenue_tax_status(db, opportunity_id, "failed", Some(reason), None)
}
...
pub fn mark_revenue_tax_confirmed(
    ...
    update_revenue_tax_status(db, opportunity_id, "completed", None, Some(tx_hash))
}
...
pub fn mark_revenue_tax_submitted(
    ...
    update_revenue_tax_status(db, opportunity_id, "in_progress", None, Some(tx_hash))
}
